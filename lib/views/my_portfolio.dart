...
class _MyPortfolioState extends State<MyPortfolio> {
  ...
  List<Project> projectList = [
    Project(
        ...
        link: "https://github.com/naserPSD/Hopital_Management"),
    Project(
      name: "Blood Bank Donor Apps",
      description: "The Android application, focusing on Java.",
      link: "https://github.com/naserPSD/BloodBank",
    ),
    Project(
      name: "Twitter Sentimental Analysis",
      description:
          "A Machine Learning based project on “ Twitter Sentimental Analysis ”.",
      link: "https://github.com/naserPSD/machinelearning",
    ),
    // Add more projects with their respective GitHub links here...
  ];
          ...
          child: InkWell(
            onTap: () {
              if (project.link.isNotEmpty) {
                ...
                // Handle empty link case, e.g., show a message or perform an action
                print('Project link is empty');
              }
            },
            onHover: (value) {
              setState(() {
