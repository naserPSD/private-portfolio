...
class _HomePageState extends State<HomePage> {
  final socialButtons = [
    ...
    AppAssets.insta,
    AppAssets.github,
    // Add more social media icons/assets here...
  ];
...
Future<void> socialLinks() async {
  const cvUrl = 'www.linkedin.com/in/md-naser-bin-hossain-9712b7285';
  if (await canLaunch(cvUrl)) {
    await launch(cvUrl);
  } else {
    throw 'Could not launch $cvUrl';
...
Future<void> gitLinks() async {
  const cvUrl = 'https://github.com/naserPSD'; // Replace with your CV file URL
  if (await canLaunch(cvUrl)) {
    await launch(cvUrl);
  } else {
    throw 'Could not launch $cvUrl';
